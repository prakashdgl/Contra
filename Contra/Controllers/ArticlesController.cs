...
namespace Contra.Controllers
{
    ...
    public class ArticlesController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int id, [Bind("Id,ArticleType,Approved,Views,OwnerID,AuthorName,ThumbnailURL,Title,Date,Tags,SummaryLong,Content")] Article article)
        {
